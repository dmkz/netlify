...
const factionSets = [
  ...
  { faction: "Варвар", variant: 1, creatures: ["Гоблины", "Наездники на волках", "Орки", "Огры", "Роки", "Циклопы", "Бегемоты", "Хобгоблины", "Налётчики на волках", "Орки-вожди", "Огры-маги", "Птицы грома", "Циклопы-короли", "Древние бегемоты"] },
